...
public class MorphologicalParser {
    ...
    public MorphologicalParser() throws IOException {
        ...
        this.hasil = new ArrayList<String>();
    }
     ...
     *
     * @param input yang sudah dihilangkan awalannya misal bertelur inputnya
     * berarti telur
    ...
    public ArrayList<String> aturanBer(String input) {
        ...
        if (null != input) //Aturan khusus untuk belunjur dan belajar
    ...
    public ArrayList<String> aturanMe(String input) {
        ...
        if (input.charAt(0) == 'm') {
             ...
             * pengecualian /p* perkara -> memperkara[i] (bukan memerkarai)
     ...
     *
     * @param input kata yang sudah dihilangkan suffixnya contoh, makanan yang
     * dimasukan adalah makan
     * @return semua string yang valid
     */
     ...
     * @return 1 string saja yang sudah dihilangkan sisipannya. misal sisipan
     * -in- pada kerja
     */
    ...
    /**
     * Seharunya ada lagi prefiks serapan asing tapi, sangat banyak
     * kemungkinannya, jadi kelompok kami tidak menangani kasus seperti itu
     * Misalnya: Bahasa Sanskerta/ Jawa Kuna / Melayu Kuna adi-, contoh:
     * adikuasa aneka-, contoh: anekabahasa antar-, contoh: antarbangsa awa-,
     * contoh: awanama catur-, contoh: caturwulan dasa-, contoh: dasawarsa dur-,
     * contoh: durhaka dwi-, contoh: dwibahasa eka-, contoh: ekasuku lajak-,
     * contoh: lajaklaku lewah-, contoh: lewahumur lir-, contoh: lirruang maha-,
     * contoh: Mahakuasa nir-, contoh: nirkabel panca-, contoh: pancaragam
     * pasca-, contoh: pascapanen pra-, contoh: prasejarah pramu-, contoh:
     * pramusiwi purba-, contoh: purbawisesa purna-, contoh: purnawaktu su-,
     * contoh: sujana swa-, contoh: swalayan tak-, contoh: taksa tan-, contoh:
     * tansuara tata-, contoh: tatakrama. tri-, contoh: triunsur tuna-, contoh:
     * tunadaksa
     *
     * Bahasa Inggris a-, contoh: amoral ab-, contoh: abnormal abs-, contoh:
     * abstrak ad-, contoh: adhesi ak-, contoh: akulturasi am-, contoh: amputasi
     * amb-, contoh: ambivalensi an-, contoh: aneurisme ana-, contoh: anabolisme
     * ant-, contoh: antasid ante-, contoh: anterior anti-, contoh: antiklinal
     * apo-, contoh: apokromatik aut-, contoh: autarki auto-, contoh: autostrada
     * bi-, contoh: bikonveks de-, contoh: dehidrasi di-, contoh: dikromatik
     * dia-, contoh: diapositif dis-, contoh: disharmoni eko-, contoh: ekologi
     * eks-, contoh: eksklusif ekso-, contoh: eksogami ekstra-, contoh:
     * ekstradisi em-, contoh: empati en-, contoh: ensenfalitis endo-, contoh:
     * endotermal epi-, contoh: epigon heksa-, contoh: heksagon hemi-, contoh:
     * hemisfer hemo-, contoh: hemoglobin hepta-, contoh: heptarki hetero-,
     * contoh: heterofil hipo-, contoh: il-, contoh: ilegal im-, contoh:
     * imigrasi in-, contoh: induksi infra-, contoh: infrasonik inter-, contoh:
     * interferensi intra-, contoh: intradermal intro-, contoh: introjeksi iso-,
     * contoh: isoenzim kata-, contoh: katalis ko-, contoh: koordinasi kom-,
     * contoh: komisi kon-, contoh: konsentrat kontra-, contoh: kontradiksi
     * kuasi-, contoh: kuasilegislatif meta-, contoh: metamorfosis mono-,
     * contoh: monodrama pan-, contoh: panasea pant-, contoh: pantisokrasi
     * panto-, contoh: pantograf para-, contoh: paraldehida penta-, contoh:
     * pentahedron peri-, contoh: perihelion poli-, contoh: polifagia pre-,
     * contoh: prematur pro-, contoh: protoraks proto-, contoh: prototipe pseu-,
     * contoh: pseudepigrafi pseudo-, contoh: pseudomorf re-, contoh:
     * rehabilitasi retro-, contoh: retrofleks semi-, contoh: semipermanen sin-,
     * contoh: sinestesia sub-, contoh: submukosa super-, contoh: supersonik
     * supra-, contoh: suprasegmental tele-, contoh: teleskop trans-, contoh:
     * transliterasi tri-, contoh: trikromat ultra-, contoh: ultramodern uni-,
     * contoh: uniseluler
     */
}
